...
hi LineNr                       guifg=#444444              ctermfg=10   guibg=NONE    ctermbg=NONE gui=NONE      cterm=NONE
hi MatchParen                   guifg=#f43753              ctermfg=203  guibg=NONE    ctermbg=NONE gui=Bold      cterm=Bold
hi NonText                      guifg=#444444              ctermfg=NONE guibg=NONE    ctermbg=NONE gui=NONE      cterm=NONE
...
hi PMenuSel                     guifg=#335261              ctermfg=249  guibg=#c9d05c ctermbg=236  gui=NONE      cterm=NONE,reverse
...
hi SpecialKey                   guifg=#444444              ctermfg=59   guibg=NONE    ctermbg=237  gui=NONE      cterm=NONE
...
hi Error                        guifg=#eeeeee              ctermfg=255  guibg=#f43753 ctermbg=131  gui=NONE      cterm=NONE
