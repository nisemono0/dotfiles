...
hi DiffAdd          ctermfg=108  ctermbg=236   cterm=NONE,reverse      guifg=#EEEEEE guibg=#5F8700 gui=bold
" hi DiffChange       ctermfg=137 ctermbg=236   cterm=NONE      guifg=NONE    guibg=NONE    gui=NONE
hi DiffChange       ctermfg=NONE ctermbg=237   cterm=NONE      guifg=NONE    guibg=NONE    gui=NONE
" hi DiffDelete       ctermfg=236  ctermbg=167  cterm=NONE      guifg=#D75F5F guibg=NONE    gui=NONE
hi DiffDelete       ctermfg=138  ctermbg=236  cterm=NONE,reverse      guifg=#D75F5F guibg=NONE    gui=NONE
" hi DiffText         ctermfg=255  ctermbg=24   cterm=bold      guifg=#EEEEEE guibg=#005F87 gui=bold
hi DiffText         ctermfg=137  ctermbg=236   cterm=NONE,reverse      guifg=#EEEEEE guibg=#005F87 gui=bold
hi Directory        ctermfg=179  ctermbg=NONE cterm=NONE      guifg=#D7AF5F guibg=NONE    gui=NONE
hi ErrorMsg         ctermfg=131  ctermbg=234  cterm=reverse      guifg=#EEEEEE guibg=#D75F5F gui=NONE
...
hi Error          ctermfg=131 ctermbg=234  cterm=reverse    guifg=#EEEEEE guibg=#D75F5F gui=NONE
...
hi SpellBad       ctermfg=167 ctermbg=NONE cterm=underline    guifg=#EEEEEE guibg=#D75F5F gui=undercurl
hi SpellCap       ctermfg=215 ctermbg=NONE cterm=underline    guifg=#EEEEEE guibg=#5FAFD7 gui=undercurl
hi SpellRare      ctermfg=175 ctermbg=NONE cterm=underline    guifg=#EEEEEE guibg=#AF87D7 gui=undercurl
hi SpellLocal     ctermfg=77  ctermbg=NONE cterm=underline    guifg=#EEEEEE guibg=#5FB3B3 gui=undercurl
...
hi Todo           ctermfg=74  ctermbg=234  cterm=inverse guifg=#5FAFD7 guibg=#1C1C1C gui=bold,reverse
